...
void loop(){
  ...
  if(state == 2 & (test[count] > 100)){
    ...
    else if(1 | (((int)(count_period - count_temp-centerErrorTolerance))>count_temp) 
  ...
  if(record_state == 1){
    ((int)(0.01*errorRate*(count_period - count_temp)))>count_temp?
