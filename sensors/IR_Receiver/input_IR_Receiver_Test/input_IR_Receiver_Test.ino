 ...
 */
#define centerErrorTolerance 1  //count
...
void loop(){
  ...
  if(state == 2 & (test[count] > 100)){
    ...
    if(1 | (((int)(count_period - count_temp+centerErrorTolerance))>count_temp) 
      ...
      pre_record++;
        ...
        Serial.print("centerErrorTolerance = ");
        Serial.println(centerErrorTolerance);
      if(pre_record == 3){
        Serial.print("count = ");
    ...
    else if(pre_record) pre_record = 0;
  }
